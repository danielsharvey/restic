...
down to the following steps:
 ...
 7. If your pull request changes anything that users should be aware
    of (a bugfix, a new feature, ...) please add an entry in
    `changelog/unreleased` using the name of the issue (`issue-8756`)
    and the template in `changelog/TEMPLATE`. It will be used in the
